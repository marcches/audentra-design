...
| 2 screens | ENR-206 **built 2026-08-22** (rename + kickers; 9.3 verified moot by design). ENR-164 **built 2026-08-22** (C2.1–C2.3, C5 inline ask). ENR-188 **built 2026-08-22** (§9.1 program in the dark slot, 9.2, B2.1 via Edward). ENR-166, ENR-207, ENR-189, ENR-184, ENR-183 to go | each card |
| 3 sweep | not started | — |
