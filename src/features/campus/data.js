...
export const campusEvents = [
  ...
  },
  {
    ...
    about:
      'The first thing on the calendar every year. No program, no speeches, just food from six campus kitchens and a lot of people who also do not know anyone yet.',
    registration: {
      kind: 'walk-in',
      label: 'No RSVP needed',
...
const REGISTRATION_TEMPLATES = {
  'walk-in': { label: 'No RSVP needed', detail: 'No registration needed.' },
  external: { label: 'Register to attend', detail: 'Registration opens on Aster’s events site.' },
  email: { label: 'RSVP by email', detail: 'Email the organizer to claim a place.' },
